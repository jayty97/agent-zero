...
For the GUI, install the last 2 packages in requirements.

To run the GUI, type python main.py --gui into the terminal

To run main.py, it's the normal python main.py

Bigbrain allows you to bring in a single larger model

Dreamteam puts 2 models of your choice together as a collaboration team for more difficult tasks.

This is far from complete, but I'm working on it!
=======
>>>>>>> origin/master
